...
class ProductService {
  ...
  Future<ProductModel> getAllProduct(String userId) async {
  ...
  // Get User Product by UserId
  Future<ProductModel> postProduct(String userId, ProductModel productModelData) async {
  ...
  // Get User Product by UserId
  Future<ProductModel> deleteOneProduct(String userId, String productId) async {
  ...
  // Get User Product by UserId
  Future<ProductModel> updateProduct(String userId, ProductModel productModelData) async {
    var body = productModelData.toJson();
