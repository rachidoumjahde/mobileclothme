import 'package:clothme/UI/order/widget/order_detail.dart';
...
class OrderListCard extends StatelessWidget {
  ...
  OrderListCard(this.planet, {this.horizontal = true});

  OrderListCard.vertical(this.planet): horizontal = false;


  @override
  Widget build(BuildContext context) {

    final orderThumbnail = new Container(
    ...
    final orderCardContent = new Container(
    ...
    return new GestureDetector(
        onTap: horizontal
          ...
          new PageRouteBuilder(
            pageBuilder: (_, __, ___) => new OrderDetailPage(planet),
